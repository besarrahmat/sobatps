...
@section('title', 'Tambah Jenis Asistensi')

@section('content')
    <main id="main" class="main">

        <div class="pagetitle">
            <h1>Tambah Jenis Asistensi</h1>
        </div><!-- End Page Title -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" method="POST" action="{{ url('extra') }}">
                    @csrf
                    ...
                    <div class="col-md-9">
                        <div class="form-floating">
                            <input type="text" class="form-control @error('jenis') is-invalid @enderror" name="jenis"
                                id="nama-master" placeholder="Jenis Kelengkapan" value="{{ old('jenis') }}" autofocus>
                    ...
                    <div class="col-md-3">
                        <div class="form-floating">
                            <input type="number" step="1" class="form-control @error('urutan') is-invalid @enderror"
                                name="urutan" id="urutan" placeholder="Urutan" value="{{ $urutan }}" disabled>
                    ...
                    <div>
                        ...
                        <textarea class="tinymce-editor @error('deskripsi') is-invalid @enderror" name="deskripsi" id="deskripsi">{{ old('deskripsi') }}</textarea>
                    ...
                    <div class="d-flex justify-content-around">
                        ...
                        <a href="{{ url('extra') }}" class="btn btn-danger btn-delete">Batal</a>
                    </div>
                </form>
